...
public class ScreenHudExampleAddon implements EchoNativeModuleEntrypoint {
    public static final String MODULE_ID = "screenhudexample";
    ...
    public void registerContent(EchoNativeModuleLoadContext context) {
        EchoNativeServiceMutation mutation = new EchoNativeServiceMutation(
                ...
                Map.of("template", "ScreenHudExampleAddon")
        );
