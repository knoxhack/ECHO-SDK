...
public class ConfigExampleAddon implements EchoNativeModuleEntrypoint {
    public static final String MODULE_ID = "configexample";
    ...
    public void registerContent(EchoNativeModuleLoadContext context) {
        EchoNativeServiceMutation mutation = new EchoNativeServiceMutation(
                ...
                Map.of("template", "ConfigExampleAddon")
        );
